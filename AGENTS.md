...
├── tag_presence.h    — Pure NFC presence policy: poll periods, removal-confirm windows, tagAbsentMisses(), playbackShouldStop() settle window (testable on native)
